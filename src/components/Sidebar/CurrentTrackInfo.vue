    ...
    >
      ...
      >
        <button
          ...
          class="close--button p-2 hover:bg-white/20 rounded-full hover:scale-110 text-white/80 transition ease-in duration-100"
        >
...
.trackInfo {
  ...
  &::after {
    ...
    background-image: linear-gradient(
      (to left, rgba(18, 18, 18, 1) 15%, rgba(18, 18, 18, 0.1) 100%)
    );
  }
}
