	...
	>
		...
		>
			...
			<ul
				v-if="visible2"
				:class="{
					'w-[15.5rem] left-[11.2rem] ': playlistPage && !albumPage,
					'w-[13.3rem] top-[13rem] left-[14.7rem]':
						TrackPage && !diskografiPage,
					'w-[13.3rem] left-[9.4rem]': albumPage && !playlistPage,
					'right-[-9.5rem] w-full top-[10rem]': diskografiPage && !TrackPage,
				}"
