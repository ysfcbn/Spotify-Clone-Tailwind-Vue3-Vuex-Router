<template>
  <div
    :class="{ ' lg:mx-[1rem]': episodes, 'hover:bg-opacwhite1': !nextEpisode }"
  ...
  >
    ...
    >
      ...
      >
        ...
        <div id="podcast" class="w-fit" v-if="!podcastShowPage">
          <router-link
      ...
      <div
        :class="{ 'col-span-full': nextEpisode }"
      ...
      >
        <div>
          <button
            id="play"
            :class="{ 'bg-white': !nextEpisode, 'bg-green3': nextEpisode }"
