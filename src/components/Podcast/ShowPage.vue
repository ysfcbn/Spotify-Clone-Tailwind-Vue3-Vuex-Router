    ...
    >
      <div class="relative flex items-end justify-start h-full lg:ml-[1rem]">
        ...
        <div class="flex flex-col text-white font-semibold px-4">
          <h2 style="font-weight: 800" class="text-xs">PODCAST</h2>
          <span>
            <h1
      ...
      <div class="flex justify-start items-center">
        ...
        >
          <button
            ...
            class="flex items-center justify-center border cursor-default w-[5.5rem] h-fit text-white px-1 py-[5px] rounded-[5px]"
          >
            <span
              ...
              >FOLLOWING</span
            >
            <span v-else class="text-sm" style="font-weight: 600"> FOLLOW</span>
          </button>
        </div>
