<template>
  ...
  >
    ...
    <div class="volume flex items-center mx-2 mb-1 w-[7.3rem]">
      ...
      <div
        id="volume-bar"
        class="group relative w-[5.8rem] max-w-[5.8rem] h-1 bg-lightest rounded-full"
      >
        <span
          class="absolute bg-white w-[0%] max-w-[5.8rem] h-1 absolute rounded-full group-hover:bg-green3"
        >
          <span
