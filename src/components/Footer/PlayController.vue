  ...
  <div class="flex flex-col min-w-[36%] shrink-0">
    ...
    >
      <div
        :class="
          isStarwarsAlbum
            ? 'mt-[2px] mb:w-[3.7rem] lg:w-[2.8rem]'
            : 'w-[2.2rem]'
        "
        class="text-[0.71rem] font-semibold tracking-widest cursor-default h-5"
      >
        {{ timeParse(trackSeek) }}
      </div>
      <div
      ...
      <div
        ...
        class="text-[0.71rem] h-5 w-[1rem] font-semibold ml-2 tracking-widest cursor-default"
      >
