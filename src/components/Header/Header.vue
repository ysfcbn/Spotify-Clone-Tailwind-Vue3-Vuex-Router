    ...
    >
      ...
      >
        ...
        <div
          ...
          class="flex items-center relative ml-1 opacity-0 truncate"
        >
          <div class="p-2 mr-2">
            <button
              @click="playResumeTrack"
              v-if="
                !isEpisodePage && !isShowPage && !isUsersPage && !isGenrePage
              "
              class="p-4 rounded-full bg-green3 p-[0.7rem] relative text-black cursor-default lg:group-hover:block hover:scale-110"
            >
              <span
                ><svg
                  role="img"
