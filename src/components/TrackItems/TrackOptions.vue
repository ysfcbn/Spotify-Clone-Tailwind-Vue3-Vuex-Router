<template>
	...
	>
		...
		>
			...
			<ul
				v-if="visibleArt"
				class="z-[9999] absolute bg-dark2 top-[5.3rem] left-[-9.8rem] p-[4px] w-[10rem] h-fit text-opacwhite3 text-sm whitespace-normal rounded cursor-default shadow-[0px_15px_15px_1px_rgba(0,0,0,0.4)]"
			>
				<li
					v-for="artist in track.artists"
					:key="artist.id"
					class="w-full p-[10px] hover:bg-dark3 flex items-center justify-center"
