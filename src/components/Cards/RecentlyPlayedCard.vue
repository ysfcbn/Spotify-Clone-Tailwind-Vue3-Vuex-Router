		...
		<div class="h-full w-full relative">
			<div class="w-full relative">
				...
				<div
					...
					class="bg-dark rounded-full right-0 bottom-0 absolute flex items-center mx-2 group-hover:block opacity-0 group-hover:opacity-100 transition ease-in duration-200 group-hover:translate-y-[-0.4rem]"
				>
					<button
						@click="
							playContextUri(
