const playlistModule = {
  ...
  mutations: {
    ...
    recommendationsTracks(state, payload) {
      state.recommendationsTracks = payload;
    },
  },
  actions: {
    ...
    async recommendationsTracks({ commit }, payload) {
      commit("recommendationsTracks", payload);
    },
  },
  getters: {
    getPlaylist(state) {
    ...
    getRecommendationsTracks(state) {
      return state.recommendationsTracks;
    },
  },
};
