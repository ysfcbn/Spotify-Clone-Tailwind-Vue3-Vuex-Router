<template>
	<footer id="footer ">
		<div
			class="md:w-full footer--contaier mt-[4rem] flex items-start justify-between flex-wrap"
		>
			<div
			...
			>
				<div class="w-[180px] max-w-[208px] mb-8 mr-[24px]">
					...
					<ul class="text-textColor3 flex flex-col gap-2">
						...
						<li class="footer--bottom--link"><a href="#">Kariyer</a></li>
						<li class="footer--bottom--link"><a href="#">For the Record</a></li>
					</ul>
				</div>
				<div class="w-[180px] max-w-[208px] mb-8 mr-[24px]">
					<p class="font-semibold text-white text-lg tracking-tighter mb-2">
					...
					<ul class="text-textColor3 flex flex-col gap-2">
						...
						<li class="footer--bottom--link"><a href="#">Geliştiriciler</a></li>
						<li class="footer--bottom--link"><a href="#">Reklam</a></li>
						<li class="footer--bottom--link"><a href="#">Yatırımcılar</a></li>
						<li class="footer--bottom--link"><a href="#">Satıcılar</a></li>
					</ul>
				</div>
				<div class="w-[180px] max-w-[208px] mb-8 mr-[24px]">
					<p class="font-semibold text-white text-lg tracking-tighter mb-2">
		...
		>
			<div class="text-textColor3 flex item-center gap-3 flex-wrap">
				...
				<a href="#"
					><span class="footer--bottom--link">Gizlilik Merkezi</span></a
				>
				<a href="#"
					><span class="footer--bottom--link">Gizilik Politikası</span></a
				>
				<a href="#"
					><span class="footer--bottom--link">Tanımlama Bilgileri</span></a
				>
				<a href="#"
